...
export default function Home() {
  ...
  const securityTopics = [
    ...
    //   description: "Desarrollo seguro para dispositivos conectados y protección de infraestructuras IoT.",
    //   icon: <Cpu className="h-8 w-8 text-orange-500 mb-4" />,
    //   href: "#",
    //   color: "border-orange-500 hover:bg-orange-500/10",
    //   comingSoon: true,
    // },
    // {
    //   title: "Amenazas Emergentes",
    //   description: "Análisis técnico de nuevos vectores de ataque y técnicas de explotación emergentes.",
    //   icon: <AlertTriangle className="h-8 w-8 text-pink-500 mb-4" />,
    //   href: "#",
    ...
    //   description: "Metodologías y procedimientos técnicos para la gestión de brechas de seguridad.",
    //   icon: <Bell className="h-8 w-8 text-teal-500 mb-4" />,
    //   href: "#",
