import { PenToolIcon, Smartphone } from "lucide-react";
        ...
        <header className="py-12 px-4 md:px-8 lg:px-16 text-center">
            <motion.div
                ...
                <motion.div
                    ...
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ duration: 1 }}
                    className="inline-block p-2 bg-amber-600 rounded-xl mb-4">
                    <PenToolIcon size={48} />
                </motion.div>
                <motion.h1
                    ...
                    transition={{ duration: 1 }}
                    className="text-4xl/normal md:text-5xl/normal font-bold mb-4 ">Recursos Útiles</motion.h1>
                <motion.p
                    initial={{ opacity: 0, x: -100 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ duration: 1 }}
